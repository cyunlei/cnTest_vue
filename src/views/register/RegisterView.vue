  ...
  <div class="register-page">
    <div class="hero">
      <div class="hero-content">
        <div class="logo">
          ...
          <span class="logo-text">cnTest</span>
        </div>
        <h1 class="slogan">全场景自动化测试<br />高效交付</h1>
        <ul class="features">
          <li><span class="check">✓</span> 永久免费</li>
          <li><span class="check">✓</span> 实时在线</li>
          <li><span class="check">✓</span> 需求管理/测试/持续交付</li>
        </ul>
        <div class="footer-links">
          © 2026 Js.Design Inc. All rights reserved.
          <a href="#">服务条款</a>
          <a href="#">隐私协议</a>
        </div>
      </div>
    ...
    <div class="form-wrap">
      <div class="register-card">
        ...
        <p class="login-hint">
          已有账户?<router-link to="/login" class="link">前去登录</router-link>
        ...
        <div v-else class="form-body">
          <div class="field">
            <div class="input-wrap">
              ...
              <input v-model="email" type="email" placeholder="输入邮箱" class="input" />
            </div>
            <p v-if="emailSendTip" class="field-tip">{{ emailSendTip }}</p>
          </div>
